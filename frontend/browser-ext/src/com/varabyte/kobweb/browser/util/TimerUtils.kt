 ...
 * @return A [CancellableActionHandle] to the action being invoked. Use [CancellableActionHandle.cancel] to cancel the action.
 */
@IgnorableReturnValue fun WindowOrWorkerGlobalScope.setTimeout(timeout: Duration, block: () -> Unit): CancellableActionHandle {
 ...
 * @return A [CancellableActionHandle] to the action being invoked. Use [CancellableActionHandle.cancel] to cancel the action.
 */
@IgnorableReturnValue fun WindowOrWorkerGlobalScope.setInterval(delay: Duration, block: CancellableIntervalScope.() -> Unit): CancellableActionHandle {
 ...
 * @return A [CancellableActionHandle] to the action being invoked. Use [CancellableActionHandle.cancel] to cancel the action.
 */
@IgnorableReturnValue fun WindowOrWorkerGlobalScope.setInterval(initialDelay: Duration, delay: Duration, block: CancellableIntervalScope.() -> Unit): CancellableActionHandle {
    lateinit var cancelHandle: CancellableActionHandle
    val scope = object : CancellableIntervalScope {
        override fun cancelInterval() {
            cancelHandle.cancel()
 ...
 * @return A [CancellableActionHandle] to the action being invoked. Use [CancellableActionHandle.cancel] to cancel the action.
 */
@IgnorableReturnValue fun WindowOrWorkerGlobalScope.invokeThenInterval(delay: Duration, block: CancellableIntervalScope.() -> Unit): CancellableActionHandle {
